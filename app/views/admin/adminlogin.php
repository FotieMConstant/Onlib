...
<head>
    ...
    <link href="assets/fontawesome-free-5.4.1-web/css/all.min.css" rel="stylesheet">
    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
          ...
          <div class="fadeIn first">
            <img src="assets/images/dp/avatar.png" title="Default, login to add profile image" id="icon" alt="User Icon" />
          </div>
          ...
          <form method="POST" action="adminlogin.php">
            ...
            <a href="index.php" title="Go back to previous page">Go back</a>
