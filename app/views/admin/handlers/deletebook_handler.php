...
<?php
require '../../../controllers/models/config.php';
  ...
  if(isset($_GET['delete_id?v'])){
    ...
    $target_id_to_delete = $_GET['delete_id?v'];
                ...
                // Delete record!
                $delquery = "DELETE FROM book WHERE id ='".$target_id_to_delete."'";
           ...
           echo '<div class="alert alert-danger"><center><strong>Sorry!</strong> , could not delete student. Please Please try again later</div></center>';
         }
